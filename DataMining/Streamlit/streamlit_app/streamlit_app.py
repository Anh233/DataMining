...
st.image("https://i.ibb.co/Wgbg6wF/Customer-Lifetime-value-new-1.jpg", use_column_width = True)


data = st.file_uploader("File Uploader")

st.sidebar.image("https://i.ibb.co/MNcWXYd/th.jpg", width = 120)
st.sidebar.markdown(""" **Group 4 - Data Mining** """)
...
[Example CSV Input File](https://drive.google.com/file/d/1VhhMmuVeTEEd8qDnvaX62PNdbMcB0dz1/view?usp=drive_link)
...
Also, please make sure the columns are in proper format. For reference you can download the [dummy data](https://drive.google.com/file/d/1VhhMmuVeTEEd8qDnvaX62PNdbMcB0dz1/view?usp=sharing).
